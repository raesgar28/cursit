...
mySQL="DELETE FROM idiomas where id_idioma =" & pks(i) & " "
set ob_rs=Ob_Conn.execute(mySQL)
mySQL="DELETE FROM rel where id_idioma =" & pks(i) & " and (id_destino=0 and id_ciudad=0 and id_seccion=0 and id_subSeccion=0 and id_item=0 and id_itemSub=0 and id_itemOp=0 and id_idioma=0 and id_alo_tipo=0 and id_alojamiento=0 and id_alo_opcion=0 and id_suplemento=0 and id_aeropuerto=0 and id_general=0)"
set ob_rs=Ob_Conn.execute(mySQL)
'SEGUNDO PONEMOS A 0 SI ALGUN OTRO CAMPO NO ESTA A 0
mySQL3="UPDATE rel SET "
mySQL3=mySQL3 & "id_idioma =  0 "
mySQL3=mySQL3 & " WHERE id_idioma = " & pks(i) & "" 
