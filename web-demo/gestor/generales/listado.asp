...
<li><a href="#">Listado Páginas</a></li>
</ol>
</div>
<div class="row">
<div class="col-md-12">
...
<div class="caption"><i class="icon-settings font-green"></i><span class="caption-subject font-green sbold uppercase">Listado | Páginas registradas</span></div>
<div class="actions">
<div class="btn-group">
...
<%Sql= "SELECT * from generales WHERE tipo='gn'"   
...
<td>
<%Sql2= "SELECT id_general, id_pag_sup from rel where id_general="&ob_rs("id_general")&" and id_pag_sup<>0 "   '[ASOCIAMOS CON PÄGINA]
Ob_Command.CommandText = Sql2
SET Ob_RS2 = Ob_Command.Execute ()
if not ob_rs2.eof then
do while not ob_rs2.eof
id_pag_sup=ob_rs2("id_pag_sup")
if id_pag_sup<>""then
	Sql3= "SELECT id_general, titulo_esp from generales where id_general="&id_pag_sup&" "   '[ASOCIAMOS CON PÄGINA]
	Ob_Command.CommandText = Sql3
...
<li><a href="acciones.jpk2?enc=<%=EnCrypt("?r="&r&"&rd="&rd&"&n="&n&"&ndos="&ndos&"&ntres="&ntres&"&ncuat="&ncuat&"&check="&ob_rs("id_general")&"&accion=des")%>&" ><i class="fa fa-star" aria-hidden="true"></i> Destacado</a></li>
<%Encryption_Key = mid(ReadKeyFromFile(Encryption_KeyLocation),1,Len("?r=" & r & "&rd=" & rd &"&n="&n&"&ndos="&ndos&"&ntres="&ntres&"&ncuat="&ncuat&"&check="&ob_rs("id_general")&"&accion=des_no"))%>
<li><a href="acciones.jpk2?enc=<%=EnCrypt("?r="&r&"&rd="&rd&"&n="&n&"&ndos="&ndos&"&ntres="&ntres&"&ncuat="&ncuat&"&check="&ob_rs("id_general")&"&accion=des_no")%>&"  ><i class="fa fa-star-half-o" aria-hidden="true"></i> No destacado</a></li>
<li class="divider"></li>
