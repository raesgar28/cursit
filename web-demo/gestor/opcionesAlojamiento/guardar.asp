...
if op="up" then
Sql= "SELECT * from alo_op where titulo_esp='"&titulo_esp&"' and id_alo_op <> "&cod&" "     '[CHEQUEAMOS QUE URL NO DENTRO UP]
else
Sql= "SELECT * from alo_op where titulo_esp='"&titulo_esp&"'"                              '[CHEQUEAMOS QUE URL NO DENTRO IN]
end if
...
mySQL="INSERT INTO alo_op (titulo_esp,texto_esp,orden,fecha_in)" 				
