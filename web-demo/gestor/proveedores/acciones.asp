...
mySQL="DELETE FROM proveedores where id_proveedor =" & pks(i) & " "
set ob_rs=Ob_Conn.execute(mySQL)
                                  ' //////////////  PRIMERO ELIMINAMOS SI SOLO SE RELACIONA CON ARCHIVO
mySQL="DELETE FROM rel where id_proveedor =" & pks(i) & " and (id_categoria=0 and id_destino=0 and id_ciudad=0 and id_seccion=0 and id_subSeccion=0 and id_item=0 and id_itemSub=0 and id_itemOp=0 and id_idioma=0 and id_alo_tipo=0 and id_alojamiento=0 and id_alo_opcion=0 and id_suplemento=0 and id_aeropuerto=0 and id_general=0)"
'and (id_categoria=0 and id_destino=0 and id_ciudad=0 and id_curso_tipo=0 and id_curso_tipo_sub=0 and id_curso_programa=0 and id_curso=0 and id_opcion=0 and id_idioma=0 and id_alo_tipo=0 and id_alojamiento=0 and id_alo_opcion=0 and id_suplemento=0 and id_aeropuerto=0 and id_general=0) "
set ob_rs=Ob_Conn.execute(mySQL)
'SEGUNDO PONEMOS A 0 SI ALGUN OTRO CAMPO NO ESTA A 0
mySQL3="UPDATE rel SET "
mySQL3=mySQL3 & "id_proveedor =  0 "
mySQL3=mySQL3 & " WHERE id_proveedor = " & pks(i) & "" 
set ob_rs=Ob_Conn.execute(mySQL3)
'response.redirect("listado.jpk2?r="&r&"&rd="&rd&"&n="&n&"&ndos="&ndos&"&ntres="&ntres&"&ncuat="&ncuat&"&ms=ok_del")'[REDIRECCIONAMOS]
