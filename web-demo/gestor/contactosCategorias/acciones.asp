...
mySQL="DELETE FROM contactosCategoria where id_contactoCategoria =" & pks(i) & " "
set ob_rs=Ob_Connb.execute(mySQL)
mySQL3="UPDATE contactos SET "
mySQL3=mySQL3 & "id_contactoCategoria =  0 "
mySQL3=mySQL3 & " WHERE id_contactoCategoria = " & pks(i) & "" 
