...
mySQL="DELETE FROM fluctuaciones where id_fluctuacion =" & pks(i) & " "
set ob_rs=Ob_Conn.execute(mySQL)
mySQL="DELETE FROM fluctuaciones_rel where id_fluctuacion =" & pks(i) & " "
set ob_rs=Ob_Conn.execute(mySQL)
end if                                      '////////////   FIN SI ELEGIMOS ELIMINAR
if accion="dis"then                            '////////////   SI ELEGIMOS DISPONIBLE
mySQL3="UPDATE fluctuaciones SET "
mySQL3=mySQL3 & "disponible =  'si' "
mySQL3=mySQL3 & " WHERE id_fluctuacion = " & pks(i) & "" 
