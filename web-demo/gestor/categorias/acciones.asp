...
mySQL="DELETE FROM categorias where id_categoria =" & pks(i) & " "
set ob_rs=Ob_Conn.execute(mySQL)
Sql= "SELECT * from rel where id_categoria=" & pks(i) & " and id_archivo<>0"                           
...
mySQL="DELETE FROM rel where id_categoria =" & pks(i) & " and (id_destino=0 and id_ciudad=0 and id_seccion=0 and id_subSeccion=0 and id_item=0 and id_itemSub=0 and id_itemOp=0 and id_idioma=0 and id_alo_tipo=0 and id_alojamiento=0 and id_alo_opcion=0 and id_suplemento=0 and id_aeropuerto=0 and id_general=0) "
set ob_rs=Ob_Conn.execute(mySQL)
'SEGUNDO PONEMOS A 0 SI ALGUN OTRO CAMPO NO ESTA A 0
mySQL3="UPDATE rel SET "
mySQL3=mySQL3 & "id_categoria =  0 "
mySQL3=mySQL3 & " WHERE id_categoria = " & pks(i) & "" 
set ob_rs=Ob_Conn.execute(mySQL3)
end if                                      '////////////   FIN SI ELEGIMOS ELIMINAR
if accion="vis"then                            '////////////   SI ELEGIMOS VISIBILIAD
mySQL3="UPDATE categorias SET "
