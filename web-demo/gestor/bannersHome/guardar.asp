...
texto_esp2=trim(safeSTR(request("texto_esp2")))
...
if ntres="hm"then orden_general=9999999 end if
...
mySQL="INSERT INTO generales (titulo_esp,texto_esp,url_esp,meta_title,meta_key,meta_desc,visible,fecha_in,destacado,orden,tipo,mas_texto,texto_esp2)" 				
