var UINotific8=function(){return{init:function(){$("#notific8_show").click(function(i){
	var t={theme:$("#notific8_theme").val(),
	sticky:$("#notific8_sticky").is(":checked"),
	horizontalEdge:$("#notific8_pos_hor").val(),
	verticalEdge:$("#notific8_pos_ver").val()},
	n=$(this);""!=$.trim($("#notific8_heading").val())&&(t.heading=$.trim($("#notific8_heading").val())),
	t.sticky||(t.life=$("#notific8_life").val()),
