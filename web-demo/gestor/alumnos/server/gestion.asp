...
Sql= "SELECT id_agente, id_usuario, nom_categoria, id_categoria from programas where id_programa="&cod_prog&" order by id_programa desc"     '[DATOS AGENTE]
Set Ob_RS = Server.CreateObject("ADODB.Recordset")
Ob_RS.Open Sql, ob_connb,adOpenStatic, adCmdText
if not ob_rs.eof then
...
<div class="form-body no_pad"><%if ms_t<>""then%><div class="alert alert-success"><button class="close" data-close="alert"></button><i class="fa fa-check" aria-hidden="true"></i> <%=ms_t%></div><%end if%></div><!--RESPUESTAS-->
...
<div class="form-group form-md-line-input">
  ...
  <div class="col-md-4"><div class="input-icon"><input type="text" class="form-control" placeholder="" name="f_inicio" id="f_inicio"  maxlength="160" value="<%=f_inicio%>"><div class="form-control-focus"> </div><i class="fa fa-calendar-check-o" aria-hidden="true"></i><span class="help-block">dd/mm/aaaa</span></div></div></div>
<div class="form-group form-md-line-input"><label class="col-md-3 control-label" for="f_fin" >Fecha de regreso.</label><div class="col-md-4"><div class="input-icon"><input type="text" class="form-control" placeholder="" name="f_fin" id="f_fin" maxlength="160" value="<%if f_fin<>"01/08/1111"then%><%=f_fin%><%end if%>"><div class="form-control-focus"> </div><i class="fa fa-calendar-times-o" aria-hidden="true"></i><span class="help-block">dd/mm/aaaa</span></div></div></div>
<!--SEMANAS-->
<%if id_itemSub<>"" then
...
<div class="form-group form-md-line-input"><label class="col-md-3 control-label" for="fechaPago" >Fecha alta.</label><div class="col-md-6"><div class="input-icon"><input type="text" class="form-control" placeholder="" name="fechaPago" id="fechaPago" maxlength="160" value="<%if fechaPago<>"01/01/1000"then%><%=fechaPago%><%end if%>"><div class="form-control-focus"> </div><i class="fa fa-calendar-o" aria-hidden="true"></i><span class="help-block">dd/mm/aaaa</span></div></div></div>
...
<div class="col-md-12">
<div class="form-group form-md-line-input col-md-7"><label class="col-md-5 control-label" for="n_factura" >Nº Factura.</label><div class="col-md-7"><div class="input-icon"><input type="text" class="form-control" placeholder="<%=n_factura_p%>" name="n_factura" id="n_factura" maxlength="160" value="<%=n_factura%>" <%if gen_fac<>"si" then%>disabled<%end if%>><div class="form-control-focus"> </div><i class="fa fa-sort-numeric-desc" aria-hidden="true"></i><span class="help-block">número correlativo de factura</span></div></div></div>
<%if pr_factura_ad="si"then%><div class="form-group form-md-checkboxes col-md-5"><label class="col-md-6 control-label" for="gen_fac" onChange="codename<%=a%>()" >Generar factura.</label><div class="col-md-6"><div class="md-checkbox-list"><div class="md-checkbox"><input name="gen_fac" type="checkbox" class="md-check" id="gen_fac" value="si" onChange="codename<%=a%>()" <%if gen_fac="si" then%>checked<%end if%>><label for="pr_ajuste"></label></div></div></div></div><%end if%>
...
if n_factura_b="" or isNull(n_factura_b) then   '[SACAMOS FACTURA]%>
<!--#include file="../comun/facturas.asp"--> 
<%n_factura_c=n_factura 
else
gen_fac="si"
...
<div class="input-icon"><input  name="n_fac_<%=i_facturas%>" type="text" <%if gen_fac<>"si"then%>disabled<%end if%> class="form-control" id="n_fac_<%=i_facturas%>" placeholder="" value="<%=n_factura_c%>" maxlength="8"><div class="form-control-focus"></div><i class="fa fa-sort-numeric-asc" aria-hidden="true"></i><span class="help-block">correlativo Fnnnn-aa.</span></div></div></div></div>
...
<div class="md-checkbox"><input type="checkbox" name="gen_fac_[<%=i_facturas%>]" id="gen_fac_<%=i_facturas%>" class="md-check" value="si" onClick="codename_<%=i_facturas%>()" autocomplete="off" <%if gen_fac="si"then%>checked<%end if%>><label for="gen_fac_<%=i_facturas%>"><span></span><span class="check"></span><span class="box"></span> Generar Factura. </label></div><div class="md-checkbox"><input type="checkbox" name="factura_del_[<%=i_facturas%>]" id="factura_del_[<%=i_facturas%>]" class="md-check" value="si"><label for="factura_del_[<%=i_facturas%>]"><span></span><span class="check"></span><span class="box"></span> Eliminar. </label></div>
...
<!--#include file="../comun/facturas.asp"--> 
<%n_factura_c=n_factura '[FIN SACAMOS FACTURA]%>
<script>
...
<%if id_usuario<>"" and id_usuario<>0 then%>
<table class="table table-striped table-bordered ">
<thead>
<tr style="color:#999">
