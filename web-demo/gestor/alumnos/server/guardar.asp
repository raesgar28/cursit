...
for i=1 to 40
opp_p(i)=request("opp_p["&i&"]") 
oppc(i)=request("oppc["&i&"]")
opc_p(i)=request("opc_p["&i&"]")
opcc(i)=request("opcc["&i&"]")
next
...
'METEMOS ANTICIPOS
Dim anticipo_(40),anticipo_pre_(40),anticipo_fec_(40),anticipo_pag_(40),anticipo_estadoPago_(40),metodo_pag_(40),anticipo_del_(40)
for i=1 to 40
...
mySQL="INSERT INTO programasAnticipos (id_programa,anticipo,precio,fecha,pagado,estadoPago,metodoPago)"
mySQL=mySQL & "VALUES ("
mySQL=mySQL & "" & cod_prog & ","
...
if ok=2 then cambio="Datos modificados en tu programa." end if
...
if ok=8 then cambio="Hay nueva documentaci&oacute;n en tu &aacute;rea de usuario" end if
...
Encryption_Key = mid(ReadKeyFromFile(Encryption_KeyLocation),1,Len("?r="&r&"&rd="&rd&"&n="&n&"&ndos="&ndos&"&ntres="&ntres&"&ncuat="&ncuat&"&ms="&ok&"&cod_cat=" & cod_cat&"&cod="&cod&"&cod_prog="&cod_prog)) 
Response.Redirect "gestion.jpk2?enc=" & EnCrypt("?r="&r&"&rd="&rd&"&n="&n&"&ndos="&ndos&"&ntres="&ntres&"&ncuat="&ncuat&"&ms="&ok&"&cod_cat=" & cod_cat&"&cod="&cod&"&cod_prog="&cod_prog)%>