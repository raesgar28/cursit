...
mySQL="DELETE FROM noticias where id_noticia =" & pks(i) & " "
set ob_rs=Ob_Conn.execute(mySQL)
Sql= "SELECT * from rel where id_noticia=" & pks(i) & " and id_archivo<>0"                           
...
mySQL="DELETE FROM rel where id_noticia =" & pks(i) & " and (id_ciudad=0 and id_seccion=0 and id_subSeccion=0 and id_item=0 and id_itemSub=0 and id_itemOp=0 and id_idioma=0 and id_alo_tipo=0 and id_alojamiento=0 and id_alo_opcion=0 and id_suplemento=0 and id_aeropuerto=0)"
set ob_rs=Ob_Conn.execute(mySQL)
...
mySQL3="UPDATE noticias SET "
mySQL3=mySQL3 & "visible =  'si' "
mySQL3=mySQL3 & " WHERE id_noticia = " & pks(i) & "" 
set ob_rs=Ob_Conn.execute(mySQL3)
