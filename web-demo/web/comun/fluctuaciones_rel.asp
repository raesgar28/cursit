...
fluctuacion_a=1
'CASO CATEGORIA
Sql_R= "SELECT id_categoria FROM rel WHERE id_item="&id_item_r&" and id_categoria<>0 GROUP BY id_categoria" 
...
'CASO SECCION
if fluctua<>"si" then
Sql_R= "SELECT id_seccion FROM rel WHERE id_item="&id_item_r&" and id_seccion<>0 GROUP BY id_seccion" 
Set Ob_RS_R = Server.CreateObject("ADODB.Recordset")
Ob_RS_R.Open Sql_R, ob_conn,adOpenStatic, adCmdText
if not ob_rs_R.eof then
do while not ob_rs_R.eof
...
'CASO SUBSECCION
if fluctua<>"si" then
Sql_R= "SELECT id_subseccion FROM rel WHERE id_item="&id_item_r&" and id_subseccion<>0 GROUP BY id_subseccion" 
Set Ob_RS_R= Server.CreateObject("ADODB.Recordset")
Ob_RS_R.Open Sql_R, ob_conn,adOpenStatic, adCmdText
if not ob_rs_R.eof then
do while not ob_rs_R.eof
...
'CASO DESTINO
if fluctua<>"si" then
Sql_R= "SELECT id_destino FROM rel WHERE id_item="&id_item_r&" and id_destino<>0 GROUP BY id_destino" 
Set Ob_RS_R = Server.CreateObject("ADODB.Recordset")
Ob_RS_R.Open Sql_R, ob_conn,adOpenStatic, adCmdText
if not ob_rs_R.eof then
...
'CASO ITEMS
if fluctua<>"si" then
Sql_R= "SELECT fluctuacion, curso, alojamiento FROM fluctuaciones, fluctuaciones_rel WHERE fluctuaciones_rel.id_item="&id_item_r&" and fluctuaciones_rel.id_fluctuacion=fluctuaciones.id_fluctuacion AND fluctuaciones.disponible='si'" 
Set Ob_RS_R = Server.CreateObject("ADODB.Recordset")
Ob_RS_R.Open Sql_R, ob_conn,adOpenStatic, adCmdText
if not ob_rs_R.eof then
fluctua="si"
