...
<h1 class="c-font-uppercase c-font-bold c-font-white c-font-20 c-font-slim"><%=titulo_esp_web%> | <%=titulo_esp_div%></h1>
<h2 class="c-font-white c-font-thin c-opacity-07"><%=alt_banner%></h2></div>
...
<%if tipo<>"nt" and tipo<>"ct"and id_general<>"" and titulo_esp<>"Reuni&oacute;n"then 'GENERALES ////////////////////////////////////%>
<div class="c-content-box c-size-md c-bg-white"><div class="container"><div class="row"><div class="col-sm-12 wow animate fadeInUp"><%=texto_esp%>
...
</div><img class="c-overlay-object img-responsive" src="<%=imagen_team%>" alt="<%=ob_rs("admins.nombre")%>&nbsp;<%=ob_rs("apellidos")%>"> </div><div class="c-body" style="min-height:150px">
...
if tipo="ct" or titulo_esp="Reuni&oacute;n"then 'CONTACTO ////////////////////////////////////
tipo_pag="ct"
...
ob_rs2.close
if i=0 then%><div class="col-md-6"><%end if%>
...
<%=replace(ob_rs("texto_esp"),"http://www.schola","http://www.cursit")%></div></div>
...
<script src="//maps.google.com/maps/api/js?key=AIzaSyD-h8bR3fvRJbxUSjcdkBCy3jV_cTD0iLI&sensor=true" type="text/javascript"></script><script src="web/lib/app/gmaps/gmaps.js" type="text/javascript"></script>
<script>
var PageContact=function(){var n=function(){var n=new GMaps({div:"#gmapbg",lat:39.549108,lng:-.389724,scrollwheel:!1});n.addMarker({lat:39.549108,lng:-.389724,title:"LocalizaciÃ³n",infoWindow:{content:"<h3>Cursit Idiomas</h3><p>c/calle test, 0 00000 - Valencia - Valencia</p>"}})};return{init:function(){n()}}}();$(document).ready(function(){PageContact.init()});
